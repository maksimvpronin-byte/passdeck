...
- [x] вложения;
- [x] drag-and-drop перенос записей между группами;
- [ ] пользовательские иконки;
- [ ] Save As и conflict UI.

История записей и корзина исключены из продуктового интерфейса. Удаление записей выполняется напрямую после подтверждения.
